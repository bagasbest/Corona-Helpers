...
class FeatureHealthy extends StatefulWidget {
  const FeatureHealthy({Key? key}) : super(key: key);

  @override
  State<FeatureHealthy> createState() => _FeatureHealthyState();
}

class _FeatureHealthyState extends State<FeatureHealthy> {
  @override
                ...
                child: Stack(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Image.asset(
                        'assets/images/image_scientist.png',
                        width: MediaQuery.of(context).size.width,
